    ...
    */
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.cors().and().csrf().disable()
                ...
                .permitAll()
                .antMatchers("/api/sale-report/**", "/api/customer/report-customer", "/api/customer/info-customer/{id}", "/api/customer/report-customer-search-gender", "/api/customer/report-customer-search-age", "/api/customer/report-customer-search", "/api/customer/purchase-history/{id}", "/api/customer/purchase-products/{id}", "/api/customer/list").hasAnyRole("STAFF", "ADMIN")
